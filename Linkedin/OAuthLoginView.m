...
@synthesize requestToken, accessToken, profile, consumer,toolbarLnkDn,brbtnItmCancel;
...
- (void)requestTokenFromProvider
{
    ...
    OARequestParameter *nameParam = [[OARequestParameter alloc] initWithName:@"scope" value:@"r_fullprofile r_emailaddress r_contactinfo"];
...
- (void)dealloc
{
	[brbtnItmCancel release];
	[toolbarLnkDn release];
    [super dealloc];
}
